...
Let's now save our preprocessed data (we won't use the file conventions from the seminar, instead mimicking the conventions from the downloaded data):

```{r}
#| label: save-preprocessed-data
#| output: false

deriv_dir <- here(bids_dir, "derivatives/eegUtils/1/")
preproc_file <- here(deriv_dir, "1_N170_desc-preprocessed_eeg.rds")
